...
public class GroupMessengerProvider extends ContentProvider {
    ...
    private static final String DATABASE_NAME = "GrpMessanger";
    private static final String TABLE_NAME = "MESSAGES";
    private static final String MESSAGE_TABLE = "CREATE TABLE " + TABLE_NAME + " (key TEXT PRIMARY KEY, value TEXT NOT NULL);";


    public static final Uri providerUri = Uri.parse("content://edu.buffalo.cse.cse486586.groupmessenger2.provider" );
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        Cursor cursor = builder.query(database,null,"key='"+selection+"'",null,null,null,null);
